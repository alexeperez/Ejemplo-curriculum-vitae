...
\mobile{099 842 8362}
\phone{022 559 703}
\email{alx\_perez90@hotmail.com}
%\homepage{Homepage}
...
\begin{itemize}
   ...
   \item Modelos de Asignación de Cupo para tarjetas de crédito, créditos de consumo, hipotecarios, etc.
   \item Estudios de mercado para tarjetas de crédito.
\end{itemize}
}

\cventry{Ene 2014 -- Act.}{Analista Estadístico}{Equifax}{Quito}{}{Analista Estadístico en el área de \emph{Decisions Solutions} de Equifax:
\begin{itemize}
